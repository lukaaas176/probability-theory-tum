...
Each exam is presented as its own quiz block, and question numbering restarts inside every block. The questions come first and their solutions are bundled at the end. Use them the way you would use the real thing: work through the full block on paper with a visible line of reasoning (in the exam only justified answers earn credit), then reveal and compare every intermediate step, not just the final number.
...
#examblock(
title: "Mock exam — selected problems",
(
(
question: [
...
question: [
#subquestions(
[(i) State the strong law of large numbers with all required assumptions.],
[(ii) Give the full definition of the mode of convergence appearing in it.],
)
],
solution: [
...
#examblock(
title: "Final exam (Summer 2025) — selected problems",
(
(
question: [
#emph[(True or false, with justification.)]
...
question: [
#subquestions(
[(a) State the central limit theorem with all required assumptions.],
[(b) Give the full general definition of the mode of convergence appearing in it.],
)
],
solution: [
...
#examblock(
title: "Retake exam (Summer 2025) — selected problems",
(
(
question: [
#emph[(True or false, with justification.)]
